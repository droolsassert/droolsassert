...
[Activation report](https://github.com/droolsassert/droolsassert/wiki/7.-Activation-report) ```html<span style="font-size: 60%;font-style: italic;vertical-align: top;color:red;">new</span>```  
